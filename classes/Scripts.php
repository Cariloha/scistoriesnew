...
if (!class_exists('scistoriesScripts')) {
	...
	class scistoriesScripts
	{
		...
		const FONTAWESOME_CDN_VERSION = "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css";
		...
		public static function wp_enqueue_scripts()
		{
			...
			wp_enqueue_script('burger', scistories_URL . '/js/burger.js', array('jquery'), filemtime(scistories_DIR) . '/js/burger.js', true);
